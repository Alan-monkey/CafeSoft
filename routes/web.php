...
Route::get('/ventas', [App\Http\Controllers\VentasController::class, 'index'])->name('ventas.index');
    ...
    Route::get('/ventas/ticket/{id}', [App\Http\Controllers\CarritoController::class, 'ticket'])->name('ventas.ticket');

Route::post('/carrito/procesar-pago', [App\Http\Controllers\CarritoController::class, 'procesarPago'])
    ->middleware('auth:usuarios')
    ->name('carrito.procesar-pago');
